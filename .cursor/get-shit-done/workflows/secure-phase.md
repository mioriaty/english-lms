...
```
Task(
  prompt="Read /Users/duongto/Internal/english-edu/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/duongto/Internal/english-edu/.cursor/get-shit-done/templates/SECURITY.md`
