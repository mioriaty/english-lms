...
```bash
INIT=$(node "/Users/duongto/Internal/english-edu/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/duongto/Internal/english-edu/.cursor/get-shit-done/templates/spec.md.
